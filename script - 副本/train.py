...
class Model(torch.nn.Module):
    def __init__(self, gen_emb, domain_emb, num_classes=3, dropout=0.5, crf=False):
        ...
        self.conv11 = torch.nn.Conv1d(gen_emb.shape[1] + domain_emb.shape[1], 128, 5, padding=2)
        self.conv12 = torch.nn.Conv1d(gen_emb.shape[1] + domain_emb.shape[1], 128, 3, padding=1)
        #self.dropout = torch.nn.Dropout(dropout)

        self.conv13 = torch.nn.Conv1d(256, 256, 5, padding=2)
        self.conv14 = torch.nn.Conv1d(256, 256, 5, padding=2)
        self.conv15 = torch.nn.Conv1d(256, 256, 5, padding=2)
        self.linear_ae1 = torch.nn.Linear(256, num_classes)
